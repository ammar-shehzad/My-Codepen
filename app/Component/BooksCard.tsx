...
publicFile:Book
// setpublicFile:Dispatch<SetStateAction<Book[]>>


}

const BookCard:React.FC<BookCardProp>=({publicFile})=>{
  return(

<>
<style>{publicFile.Css}</style>


<div className="bg-gray-600 block max-w-sm border border-default rounded-base shadow-xs p-5">
    <a href="#">

<div className="bg-white rounded-2xl w-full h-[30vh]">
            
      <div
      className="editor-output"
      dangerouslySetInnerHTML={{ __html: publicFile.Html || "" }} />
</div>
    ...
    <div className="p-6 text-center">
        ...
        <a href="#">
            <h5 className="mt-3 mb-6 text-2xl font-semibold tracking-tight text-heading text-white">{publicFile.BookName}</h5>
        </a>
          <a href="#">
            <p className="mt-3 mb-6 text-lg font-semibold tracking-tight text-heading text-white">{publicFile.userName}</p>
        </a>
